    ...
    <div className="min-h-screen flex bg-white">
      ...
      <aside className="w-20 bg-white border-r border-gray-100 flex flex-col">
        ...
        <div className="mt-auto pb-6 flex flex-col items-center space-y-6">
          ...
          <button className="w-10 h-10 flex items-center justify-center rounded-full bg-pink-600 text-white">
            $
          </button>
        </div>
      </aside>
      ...
      <main className="flex-1 overflow-auto">
        <div className="container px-6 py-8 max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-10">
            <h1 className="text-2xl font-medium text-gray-900">Add New Product</h1>
            
            <div className="flex items-center gap-4">
              <button className="py-2 px-4 rounded-full border border-gray-200 hover:bg-gray-50 text-sm font-medium">
                New Product
              </button>
          ...
          {/* Upload area */}
          <div 
            className="bg-white border border-dashed border-gray-200 rounded-2xl p-20 mb-12 flex flex-col items-center justify-center cursor-pointer hover:border-brand-purple transition-colors"
            onDragOver={handleDragOver}
            onDrop={handleDrop}
            onClick={handleUpload}
          >
            <div className="mb-6">
              <button className="bg-brand-purple text-white rounded-full p-4 flex items-center justify-center">
            ...
            <h3 className="text-lg font-medium mb-1">Start Uploading</h3>
            <p className="text-gray-500 text-sm text-center mb-4">Drag & drop anywhere to add product</p>
          ...
          <div>
            <div className="flex items-center mb-6">
              <h2 className="text-xl font-medium mr-4">My Products</h2>
              <div className="text-sm text-gray-500">Monthly Product Limit 0/1</div>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {products.map((product) => (
                <div key={product.id} className="bg-gray-100 rounded-lg overflow-hidden">
                  <div className="relative">
                  ...
                  <div className="p-4 bg-white">
                    ...
                    <div className="flex flex-col space-y-1 mb-2">
                      <div className="flex items-center gap-2">
                        <div className="w-5 h-5 bg-brand-purple text-white rounded-full flex items-center justify-center text-xs">
                          👕
                        </div>
